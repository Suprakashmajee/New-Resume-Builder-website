function Avatar() {
  return (
    <div className="mx-auto mb-3 grid h-16 w-16 place-items-center overflow-hidden rounded-full bg-gradient-to-br from-amber-100 via-orange-200 to-stone-400 text-lg font-bold text-ink">
      BW
    </div>
  );
}
